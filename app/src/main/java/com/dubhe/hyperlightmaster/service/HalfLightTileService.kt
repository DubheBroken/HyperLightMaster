...
class HalfLightTileService: TileService() {
        ...
        when (qsTile.state) {
            Tile.STATE_INACTIVE -> {
                ...
                CoroutineScope(Dispatchers.Default).launch {
                    ...
                    brightness = LightApplication.instance.lightViewModel.checkBrightness(brightness / 2)
    ...
    // 关闭指定ID的Tile
    private fun closeTileById(tileId: Int) {
        // 根据Tile ID来关闭对应的Tile
        // 这里你可以按你的逻辑添加关闭Tile的代码
    }
